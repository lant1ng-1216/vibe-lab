 ...
 * THINKING â expandable agent trace, four variants
 *
 *   Steps      step list with spinner â muted checks
...
> = {
  ...
  Reasoning: {
    ...
    rows: [
      { primary: "Summer demand spikes for stone-fruit flavors â peach and apricot lead." },
...
export default function ThinkingState({ variant = "Steps", onSettled }: { variant?: string; onSettled?: () => void }) {
  ...
  return (
    ...
    >
      {/* header â shared across variants */}
      <button
        type="button"
              ...
              const content = (
                ...
                {row.add !== undefined && (
                  <span className="shrink-0 font-mono text-[11px] tabular-nums">
                    ...
                    <span className="text-red">â{row.del}</span>
                  </span>
                )}
                </>
              );

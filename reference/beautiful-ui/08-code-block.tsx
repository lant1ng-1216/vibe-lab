 ...
 *   Â· Code â a line-numbered listing
 *   Â· Diff â a unified diff: old/new gutters, a green/red accent
...
/* light syntax coloring â keywords/imports/conditionals, functions, strings & numbers */
...
export type CodeBlockProps = {
  /** Which view to render â "Code" (line-numbered listing) or "Diff". */
  variant?: string;
...
export default function CodeBlock({
  ...
  return (
    <div className="w-full max-w-105 overflow-hidden rounded-card bg-surface shadow-card">
      {/* header â file Â· (diff stat | copy) */}
      ...
      {/* body â equal 12px inset on top / left / right; lines wrap */}

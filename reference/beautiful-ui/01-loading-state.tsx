 ...
 * LOADING STATE â pixel-grid loader for long-running work
 *
 * Variants:
 *   Drive  â square cells, chevron wavefront driving right;
 *            the 650ms cycle is shorter than the sweep, so
 *            two fronts are always in flight
 *   Dots   â same wavefront, circular cells
 *   Orbit  â a comet lapping the grid perimeter
 *   Surfer â the Drive loader paired with a meme video below
 *

...
const BOUNDARIES = [
  ...
  "资源库 / 教程库免费开放；训练营课程与创始人亲自指导为付费内容（建设中）",
  "训练营正在重新打磨，暂不开放报名；开课消息会优先通知联系过我们的人",
];

/* 04 你可以来找我们（场景） */
const SCENES = [
  { icon: "💬", t: "咨询训练营", d: "训练营课程正在重做——想第一时间收到开课消息、或有想学的内容建议，加微信备注「训练营」即可。", via: "微信" },
